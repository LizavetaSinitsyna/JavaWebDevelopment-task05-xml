...
public class CandiesDOMBuilderTest {
	...
	private CandiesDOMBuilder dom;

	@Before
	public void init() throws ParserException {
		dom = new CandiesDOMBuilder();
	...
	public void testBuildCandySetByPassingValidFile() throws ParserException, IOException {
		file = CandiesDOMBuilderTest.class.getClassLoader().getResource("./resource/ValidCandies.xml").openStream();
		dom.buildCandySet(file);
		Assert.assertEquals(candies, dom.getCandies());
	}

	@Test(expected = ParserException.class)
	public void testBuildCandySetByPassingInvalidFileWithNegativeIngredientAmount()
			throws ParserException, IOException {
		file = CandiesDOMBuilderTest.class.getClassLoader()
				.getResource("./resource/InvalidCandiesWithNegativeIngredientAmount.xml").openStream();
		dom.buildCandySet(file);
	}
	...
	public void testBuildCandySetByPassingInvalidFileWithInvalidNutritionalValue() throws ParserException, IOException {
		file = CandiesDOMBuilderTest.class.getClassLoader()
				.getResource("./resource/InvalidCandiesWithInvalidNutritionalValue.xml").openStream();
		dom.buildCandySet(file);
	}
	...
	public void testBuildCandySetByPassingInvalidFileWithNegativeEnergy() throws ParserException, IOException {
		file = CandiesDOMBuilderTest.class.getClassLoader()
				.getResource("./resource/InvalidCandiesWithNegativeEnergy.xml").openStream();
		dom.buildCandySet(file);
	}

	@Test(expected = ParserException.class)
	public void testBuildCandySetByPassingNull() throws ParserException, IOException {
		dom.buildCandySet(null);
	}
